...
# enumerate()
frutas = ["manzana", "pera", "mandarian"]
for idx, fruta in enumerate(frutas): #idc, fruta pueden tener cualquier nombre lo que importa es el orden
...
# continue, omite lo que querramos omitir "loro"
print("\nContinue:")
animales = ["perro", "gato", "raton", "loro", "pez", "canario"]
for idx, animal in enumerate(animales):
    if animal == "loro": # CONTINUE puede ponerse aqui
        #print(f"El loro esta escondido en el indice {idx}")
        continue
