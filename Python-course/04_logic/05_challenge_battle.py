...
def battle(lista_a, lista_b): # pylint: disable=W0621
    puntos_a = sum(lista_a)
    puntos_b = sum(lista_b)
    #return f"{puntos_a - puntos_b}a" if puntos_a > puntos_b else f"{puntos_b - puntos_a}b" if puntos_b > puntos_a else "x" # pylint: disable=C0301
    if puntos_a > puntos_b: # pylint: disable=R1705
